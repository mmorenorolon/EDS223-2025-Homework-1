---
title: "Disparities in Air Toxic Cancer Risk Across Low-Income Communities in the Puerto Rico Metro Area"
...
#| message: false
#| results: false
ejscreen <- st_read(here("data", "ejscreen",# Read in the EJScreen data
